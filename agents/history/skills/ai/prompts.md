...
1. Context Building
Analyze the .agents/skills/skills.yaml and instructions.md file and remember all the instructions. Once you have done it, please acknowledge so that we can start coding.
